...
Function InstallVLC {
	Write-Output "Installing VLC media"
	choco install vlc -y
	choco install vlc-skins -y
}
...
Function InstallZoom {
	Write-Output "Installing Zoom client meetings"
	choco install zoom -y
}

Function InstallPowerToys {
	Write-Output "Installing PowerToys poductivity tool"
	choco install powertoys -y
}

Function InstallGrammarly {
	Write-Output "Installing Grammarly for Windows"
	choco install grammarly -y
}

Function InstallWinDirStat {
	Write-Output "Installing WinDirStat for windows"
